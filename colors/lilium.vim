...
" Filename: lua/lualine/themes/lilium.lua
" Author: llimllib
...
let g:lilium_loaded_file_types = []

if !(exists('g:colors_name') && g:colors_name ==# 'lilium' && s:configuration.better_performance)
  highlight clear
  if exists('syntax_on')
    syntax reset
  endif
...
if s:configuration.transparent_background >= 1
  call lilium#highlight('Normal', s:palette.fg, s:palette.none)
  call lilium#highlight('NormalNC', s:palette.fg, s:palette.none)
  call lilium#highlight('Terminal', s:palette.fg, s:palette.none)
  if s:configuration.show_eob
    call lilium#highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call lilium#highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  call lilium#highlight('Folded', s:palette.grey, s:palette.none)
  call lilium#highlight('ToolbarLine', s:palette.fg, s:palette.none)
  call lilium#highlight('FoldColumn', s:palette.grey_dim, s:palette.none)
else
  call lilium#highlight('Normal', s:palette.fg, s:palette.bg0)
  if s:configuration.dim_inactive_windows
    call lilium#highlight('NormalNC', s:palette.fg, s:palette.bg_dim)
  else
    call lilium#highlight('NormalNC', s:palette.fg, s:palette.bg0)
  endif
  call lilium#highlight('Terminal', s:palette.fg, s:palette.bg0)
  if s:configuration.show_eob
    if s:configuration.dim_inactive_windows
      call lilium#highlight('EndOfBuffer', s:palette.bg4, s:palette.bg_dim)
    else
      call lilium#highlight('EndOfBuffer', s:palette.bg4, s:palette.bg0)
    endif
  else
    if s:configuration.dim_inactive_windows
      call lilium#highlight('EndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
    else
      call lilium#highlight('EndOfBuffer', s:palette.bg0, s:palette.bg0)
    endif
  endif
  call lilium#highlight('Folded', s:palette.grey, s:palette.bg1)
  call lilium#highlight('ToolbarLine', s:palette.fg, s:palette.bg2)
  call lilium#highlight('FoldColumn', s:palette.grey_dim, s:palette.none)
endif
call lilium#highlight('SignColumn', s:palette.fg, s:palette.none)
call lilium#highlight('IncSearch', s:palette.bg0, s:palette.bg_red)
call lilium#highlight('Search', s:palette.bg0, s:palette.bg_green)
highlight! link CurSearch IncSearch
call lilium#highlight('ColorColumn', s:palette.none, s:palette.bg1)
call lilium#highlight('Conceal', s:palette.grey_dim, s:palette.none)
if s:configuration.cursor ==# 'auto'
  call lilium#highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call lilium#highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call lilium#highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call lilium#highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call lilium#highlight('CursorLine', s:palette.none, s:palette.bg1)
  call lilium#highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
call lilium#highlight('LineNr', s:palette.grey_dim, s:palette.none)
if &diff
  call lilium#highlight('CursorLineNr', s:palette.fg, s:palette.none, 'underline')
else
  call lilium#highlight('CursorLineNr', s:palette.fg, s:palette.none)
endif
call lilium#highlight('DiffAdd', s:palette.none, s:palette.diff_green)
call lilium#highlight('DiffChange', s:palette.none, s:palette.diff_blue)
call lilium#highlight('DiffDelete', s:palette.none, s:palette.diff_red)
call lilium#highlight('DiffText', s:palette.bg0, s:palette.blue)
call lilium#highlight('Directory', s:palette.green, s:palette.none)
call lilium#highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call lilium#highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('ModeMsg', s:palette.fg, s:palette.none, 'bold')
call lilium#highlight('MoreMsg', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('MatchParen', s:palette.none, s:palette.bg4)
call lilium#highlight('NonText', s:palette.bg4, s:palette.none)
call lilium#highlight('Whitespace', s:palette.bg4, s:palette.none)
call lilium#highlight('SpecialKey', s:palette.bg4, s:palette.none)
call lilium#highlight('Pmenu', s:palette.fg, s:palette.bg2)
call lilium#highlight('PmenuSbar', s:palette.none, s:palette.bg2)
if s:configuration.menu_selection_background ==# 'blue'
  call lilium#highlight('PmenuSel', s:palette.bg0, s:palette.bg_blue)
elseif s:configuration.menu_selection_background ==# 'green'
  call lilium#highlight('PmenuSel', s:palette.bg0, s:palette.bg_green)
elseif s:configuration.menu_selection_background ==# 'red'
  call lilium#highlight('PmenuSel', s:palette.bg0, s:palette.bg_red)
endif
call lilium#highlight('PmenuKind', s:palette.green, s:palette.bg2)
call lilium#highlight('PmenuExtra', s:palette.grey, s:palette.bg2)
highlight! link WildMenu PmenuSel
call lilium#highlight('PmenuThumb', s:palette.none, s:palette.grey)
call lilium#highlight('NormalFloat', s:palette.fg, s:palette.bg2)
call lilium#highlight('FloatBorder', s:palette.grey, s:palette.bg2)
call lilium#highlight('Question', s:palette.yellow, s:palette.none)
if s:configuration.spell_foreground ==# 'none'
  call lilium#highlight('SpellBad', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call lilium#highlight('SpellCap', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call lilium#highlight('SpellLocal', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call lilium#highlight('SpellRare', s:palette.none, s:palette.none, 'undercurl', s:palette.purple)
else
  call lilium#highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
  call lilium#highlight('SpellCap', s:palette.yellow, s:palette.none, 'undercurl', s:palette.yellow)
  call lilium#highlight('SpellLocal', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
  call lilium#highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
endif
if s:configuration.transparent_background == 2
  call lilium#highlight('StatusLine', s:palette.fg, s:palette.none)
  call lilium#highlight('StatusLineTerm', s:palette.fg, s:palette.none)
  call lilium#highlight('StatusLineNC', s:palette.grey, s:palette.none)
  call lilium#highlight('StatusLineTermNC', s:palette.grey, s:palette.none)
  call lilium#highlight('TabLine', s:palette.fg, s:palette.bg4)
  call lilium#highlight('TabLineFill', s:palette.grey, s:palette.none)
  call lilium#highlight('TabLineSel', s:palette.bg0, s:palette.bg_red)
else
  call lilium#highlight('StatusLine', s:palette.fg, s:palette.bg3)
  call lilium#highlight('StatusLineTerm', s:palette.fg, s:palette.bg3)
  call lilium#highlight('StatusLineNC', s:palette.grey, s:palette.bg1)
  call lilium#highlight('StatusLineTermNC', s:palette.grey, s:palette.bg1)
  call lilium#highlight('TabLine', s:palette.fg, s:palette.bg4)
  call lilium#highlight('TabLineFill', s:palette.grey, s:palette.bg1)
  call lilium#highlight('TabLineSel', s:palette.bg0, s:palette.bg_red)
endif
if s:configuration.dim_inactive_windows
  call lilium#highlight('VertSplit', s:palette.bg4, s:palette.bg_dim)
else
  call lilium#highlight('VertSplit', s:palette.black, s:palette.none)
endif
highlight! link WinSeparator VertSplit
call lilium#highlight('Visual', s:palette.none, s:palette.bg3)
call lilium#highlight('VisualNOS', s:palette.none, s:palette.bg3, 'underline')
call lilium#highlight('QuickFixLine', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('Debug', s:palette.yellow, s:palette.none)
call lilium#highlight('debugPC', s:palette.bg0, s:palette.green)
call lilium#highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call lilium#highlight('ToolbarButton', s:palette.bg0, s:palette.bg_blue)
if has('nvim')
  call lilium#highlight('Substitute', s:palette.bg0, s:palette.yellow)
...
if s:configuration.enable_italic
  call lilium#highlight('Type', s:palette.blue, s:palette.none, 'italic')
  call lilium#highlight('Structure', s:palette.blue, s:palette.none, 'italic')
  call lilium#highlight('StorageClass', s:palette.blue, s:palette.none, 'italic')
  call lilium#highlight('Identifier', s:palette.orange, s:palette.none, 'italic')
  call lilium#highlight('Constant', s:palette.orange, s:palette.none, 'italic')
else
  call lilium#highlight('Type', s:palette.blue, s:palette.none)
  call lilium#highlight('Structure', s:palette.blue, s:palette.none)
  call lilium#highlight('StorageClass', s:palette.blue, s:palette.none)
  call lilium#highlight('Identifier', s:palette.orange, s:palette.none)
  call lilium#highlight('Constant', s:palette.orange, s:palette.none)
endif
call lilium#highlight('PreProc', s:palette.red, s:palette.none)
call lilium#highlight('PreCondit', s:palette.red, s:palette.none)
call lilium#highlight('Include', s:palette.red, s:palette.none)
call lilium#highlight('Keyword', s:palette.red, s:palette.none)
call lilium#highlight('Define', s:palette.red, s:palette.none)
call lilium#highlight('Typedef', s:palette.red, s:palette.none)
call lilium#highlight('Exception', s:palette.red, s:palette.none)
call lilium#highlight('Conditional', s:palette.red, s:palette.none)
call lilium#highlight('Repeat', s:palette.red, s:palette.none)
call lilium#highlight('Statement', s:palette.red, s:palette.none)
call lilium#highlight('Macro', s:palette.purple, s:palette.none)
call lilium#highlight('Error', s:palette.red, s:palette.none)
call lilium#highlight('Label', s:palette.purple, s:palette.none)
call lilium#highlight('Special', s:palette.purple, s:palette.none)
call lilium#highlight('SpecialChar', s:palette.purple, s:palette.none)
call lilium#highlight('Boolean', s:palette.purple, s:palette.none)
call lilium#highlight('String', s:palette.yellow, s:palette.none)
call lilium#highlight('Character', s:palette.yellow, s:palette.none)
call lilium#highlight('Number', s:palette.purple, s:palette.none)
call lilium#highlight('Float', s:palette.purple, s:palette.none)
call lilium#highlight('Function', s:palette.green, s:palette.none)
call lilium#highlight('Operator', s:palette.red, s:palette.none)
call lilium#highlight('Title', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('Tag', s:palette.orange, s:palette.none)
call lilium#highlight('Delimiter', s:palette.fg, s:palette.none)
call lilium#highlight('Todo', s:palette.bg0, s:palette.blue, 'bold')
if s:configuration.disable_italic_comment
  call lilium#highlight('Comment', s:palette.grey, s:palette.none)
  call lilium#highlight('SpecialComment', s:palette.grey, s:palette.none)
else
  call lilium#highlight('Comment', s:palette.grey, s:palette.none, 'italic')
  call lilium#highlight('SpecialComment', s:palette.grey, s:palette.none, 'italic')
endif
call lilium#highlight('Ignore', s:palette.grey, s:palette.none)
call lilium#highlight('Underlined', s:palette.none, s:palette.none, 'underline')
" }}}
" Predefined Highlight Groups: {{{
call lilium#highlight('Fg', s:palette.fg, s:palette.none)
call lilium#highlight('Grey', s:palette.grey, s:palette.none)
call lilium#highlight('Red', s:palette.red, s:palette.none)
call lilium#highlight('Orange', s:palette.orange, s:palette.none)
call lilium#highlight('Yellow', s:palette.yellow, s:palette.none)
call lilium#highlight('Green', s:palette.green, s:palette.none)
call lilium#highlight('Blue', s:palette.blue, s:palette.none)
call lilium#highlight('Purple', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call lilium#highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call lilium#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call lilium#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call lilium#highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call lilium#highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call lilium#highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call lilium#highlight('RedItalic', s:palette.red, s:palette.none)
  call lilium#highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call lilium#highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call lilium#highlight('GreenItalic', s:palette.green, s:palette.none)
  call lilium#highlight('BlueItalic', s:palette.blue, s:palette.none)
  call lilium#highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
call lilium#highlight('RedSign', s:palette.red, s:palette.none)
call lilium#highlight('OrangeSign', s:palette.orange, s:palette.none)
call lilium#highlight('YellowSign', s:palette.yellow, s:palette.none)
call lilium#highlight('GreenSign', s:palette.green, s:palette.none)
call lilium#highlight('BlueSign', s:palette.blue, s:palette.none)
call lilium#highlight('PurpleSign', s:palette.purple, s:palette.none)
if s:configuration.diagnostic_text_highlight
  call lilium#highlight('ErrorText', s:palette.none, s:palette.diff_red, 'undercurl', s:palette.red)
  call lilium#highlight('WarningText', s:palette.none, s:palette.diff_yellow, 'undercurl', s:palette.yellow)
  call lilium#highlight('InfoText', s:palette.none, s:palette.diff_blue, 'undercurl', s:palette.blue)
  call lilium#highlight('HintText', s:palette.none, s:palette.diff_green, 'undercurl', s:palette.green)
else
  call lilium#highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call lilium#highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call lilium#highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call lilium#highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call lilium#highlight('ErrorLine', s:palette.none, s:palette.diff_red)
  call lilium#highlight('WarningLine', s:palette.none, s:palette.diff_yellow)
  call lilium#highlight('InfoLine', s:palette.none, s:palette.diff_blue)
  call lilium#highlight('HintLine', s:palette.none, s:palette.diff_green)
else
...
elseif s:configuration.diagnostic_virtual_text ==# 'colored'
  ...
  call lilium#highlight('VirtualTextWarning', s:palette.yellow, s:palette.diff_yellow)
  call lilium#highlight('VirtualTextError', s:palette.red, s:palette.diff_red)
  call lilium#highlight('VirtualTextInfo', s:palette.blue, s:palette.diff_blue)
  call lilium#highlight('VirtualTextHint', s:palette.green, s:palette.diff_green)
endif
call lilium#highlight('ErrorFloat', s:palette.red, s:palette.bg2)
call lilium#highlight('WarningFloat', s:palette.yellow, s:palette.bg2)
call lilium#highlight('InfoFloat', s:palette.blue, s:palette.bg2)
call lilium#highlight('HintFloat', s:palette.green, s:palette.bg2)
if &diff
  call lilium#highlight('CurrentWord', s:palette.bg0, s:palette.green)
elseif s:configuration.current_word ==# 'grey background'
  call lilium#highlight('CurrentWord', s:palette.none, s:palette.bg2)
else
  call lilium#highlight('CurrentWord', s:palette.none, s:palette.none, s:configuration.current_word)
endif
" Define a color for each LSP item kind to create highlights for nvim-cmp, aerial.nvim, nvim-navic and coc.nvim
let g:lilium_lsp_kind_color = [
      \ ["Array", "Yellow"],
      \ ["Boolean", "Yellow"],
      \ ["Class", "Blue"],
      \ ["Color", "Yellow"],
...
call lilium#highlight('TSStrong', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('TSEmphasis', s:palette.none, s:palette.none, 'italic')
call lilium#highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
call lilium#highlight('TSNote', s:palette.bg0, s:palette.green, 'bold')
call lilium#highlight('TSWarning', s:palette.bg0, s:palette.yellow, 'bold')
call lilium#highlight('TSDanger', s:palette.bg0, s:palette.red, 'bold')
...
" }}}
" neoclide/coc.nvim {{{
call lilium#highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
call lilium#highlight('CocSearch', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('CocPumSearch', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('CocMarkdownHeader', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('CocMarkdownLink', s:palette.green, s:palette.none, 'underline')
...
call lilium#highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_match1', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_match2', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_match3', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_match4', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_matchRefine', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('Lf_hl_popup_normalMode', s:palette.bg0, s:palette.blue, 'bold')
call lilium#highlight('Lf_hl_popup_inputMode', s:palette.bg0, s:palette.green, 'bold')
call lilium#highlight('Lf_hl_popup_category', s:palette.fg, s:palette.bg4)
call lilium#highlight('Lf_hl_popup_nameOnlyMode', s:palette.fg, s:palette.bg3)
call lilium#highlight('Lf_hl_popup_fullPathMode', s:palette.fg, s:palette.bg3)
call lilium#highlight('Lf_hl_popup_fuzzyMode', s:palette.fg, s:palette.bg3)
call lilium#highlight('Lf_hl_popup_regexMode', s:palette.fg, s:palette.bg3)
call lilium#highlight('Lf_hl_popup_lineInfo', s:palette.bg0, s:palette.blue)
call lilium#highlight('Lf_hl_popup_total', s:palette.bg0, s:palette.red)
call lilium#highlight('Lf_hl_popup_cursor', s:palette.bg0, s:palette.blue)
...
" }}}
" liuchengxu/vim-clap {{{
call lilium#highlight('ClapSelected', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('ClapCurrentSelection', s:palette.none, s:palette.bg0, 'bold')
call lilium#highlight('ClapSpinner', s:palette.blue, s:palette.bg2, 'bold')
call lilium#highlight('ClapBlines', s:palette.fg, s:palette.none)
call lilium#highlight('ClapProviderId', s:palette.fg, s:palette.none, 'bold')
call lilium#highlight('ClapMatches1', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('ClapMatches2', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('ClapMatches3', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('ClapMatches4', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('ClapMatches5', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('ClapFuzzyMatches', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('ClapNoMatchesFound', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim{{{
call lilium#highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call lilium#highlight('deniteInput', s:palette.green, s:palette.bg1, 'bold')
call lilium#highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg1)
call lilium#highlight('deniteStatusLinePath', s:palette.fg, s:palette.bg1)
highlight! link deniteSelectedLine Green
" }}}
" kien/ctrlp.vim{{{
call lilium#highlight('CtrlPMatch', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('CtrlPPrtBase', s:palette.grey, s:palette.none)
call lilium#highlight('CtrlPLinePre', s:palette.grey, s:palette.none)
call lilium#highlight('CtrlPMode1', s:palette.blue, s:palette.bg1, 'bold')
call lilium#highlight('CtrlPMode2', s:palette.bg1, s:palette.blue, 'bold')
call lilium#highlight('CtrlPStats', s:palette.grey, s:palette.bg1, 'bold')
...
call lilium#highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call lilium#highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call lilium#highlight('SneakLabelMask', s:palette.bg_green, s:palette.bg_green)
...
call lilium#highlight('VMCursor', s:palette.blue, s:palette.grey_dim)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call lilium#highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg1)
  call lilium#highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg2)
endif
" }}}
...
call lilium#highlight('QuickScopePrimary', s:palette.green, s:palette.none, 'underline')
call lilium#highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
if has('nvim')
" hrsh7th/nvim-cmp {{{
call lilium#highlight('CmpItemAbbrMatch', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('CmpItemAbbrMatchFuzzy', s:palette.green, s:palette.none, 'bold')
...
for kind in g:lilium_lsp_kind_color
...
call lilium#highlight('TelescopeMatching', s:palette.green, s:palette.none, 'bold')
...
" }}}
" phaazon/hop.nvim {{{
call lilium#highlight('HopNextKey', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('HopNextKey1', s:palette.blue, s:palette.none, 'bold')
highlight! link HopNextKey2 Blue
highlight! link HopUnmatched Grey
" }}}
" lukas-reineke/indent-blankline.nvim {{{
call lilium#highlight('IndentBlanklineContextChar', s:palette.grey, s:palette.none, 'nocombine')
call lilium#highlight('IndentBlanklineChar', s:palette.grey_dim, s:palette.none, 'nocombine')
...
" }}}
" romgrk/barbar.nvim {{{
call lilium#highlight('BufferCurrent', s:palette.fg, s:palette.bg0)
call lilium#highlight('BufferCurrentIndex', s:palette.fg, s:palette.bg0)
call lilium#highlight('BufferCurrentMod', s:palette.blue, s:palette.bg0)
call lilium#highlight('BufferCurrentSign', s:palette.red, s:palette.bg0)
call lilium#highlight('BufferCurrentTarget', s:palette.red, s:palette.bg0, 'bold')
call lilium#highlight('BufferVisible', s:palette.fg, s:palette.bg_dim)
call lilium#highlight('BufferVisibleIndex', s:palette.fg, s:palette.bg_dim)
call lilium#highlight('BufferVisibleMod', s:palette.blue, s:palette.bg_dim)
call lilium#highlight('BufferVisibleSign', s:palette.red, s:palette.bg_dim)
call lilium#highlight('BufferVisibleTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call lilium#highlight('BufferInactive', s:palette.grey, s:palette.bg_dim)
call lilium#highlight('BufferInactiveIndex', s:palette.grey, s:palette.bg_dim)
call lilium#highlight('BufferInactiveMod', s:palette.grey, s:palette.bg_dim)
call lilium#highlight('BufferInactiveSign', s:palette.grey_dim, s:palette.bg_dim)
call lilium#highlight('BufferInactiveTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call lilium#highlight('BufferTabpages', s:palette.grey, s:palette.bg_dim, 'bold')
call lilium#highlight('BufferTabpageFill', s:palette.bg_dim, s:palette.bg_dim)
" }}}
...
call lilium#highlight('DapUIModifiedValue', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('DapUIBreakpointsCurrentLine', s:palette.blue, s:palette.none, 'bold')
...
call lilium#highlight('LspFloatWinBorder', s:palette.bg0, s:palette.bg0)
call lilium#highlight('LspSagaDiagnosticHeader', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('LspSagaCodeActionTitle', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('DefinitionPreviewTitle', s:palette.purple, s:palette.none, 'bold')
...
" }}}
" b0o/incline.nvim {{{
call lilium#highlight('InclineNormalNC', s:palette.grey, s:palette.bg2)
" }}}
" echasnovski/mini.nvim {{{
call lilium#highlight('MiniIndentscopePrefix', s:palette.none, s:palette.none, 'nocombine')
call lilium#highlight('MiniJump2dSpot', s:palette.red, s:palette.none, 'bold,nocombine')
call lilium#highlight('MiniStarterCurrent', s:palette.none, s:palette.none, 'nocombine')
call lilium#highlight('MiniStatuslineDevinfo', s:palette.fg, s:palette.bg3)
call lilium#highlight('MiniStatuslineFileinfo', s:palette.fg, s:palette.bg3)
call lilium#highlight('MiniStatuslineFilename', s:palette.grey, s:palette.bg1)
call lilium#highlight('MiniStatuslineModeInactive', s:palette.grey, s:palette.bg1)
call lilium#highlight('MiniStatuslineModeCommand', s:palette.bg0, s:palette.yellow, 'bold')
call lilium#highlight('MiniStatuslineModeInsert', s:palette.bg0, s:palette.bg_green, 'bold')
call lilium#highlight('MiniStatuslineModeNormal', s:palette.bg0, s:palette.bg_blue, 'bold')
call lilium#highlight('MiniStatuslineModeOther', s:palette.bg0, s:palette.purple, 'bold')
call lilium#highlight('MiniStatuslineModeReplace', s:palette.bg0, s:palette.orange, 'bold')
call lilium#highlight('MiniStatuslineModeVisual', s:palette.bg0, s:palette.bg_red, 'bold')
call lilium#highlight('MiniTablineCurrent', s:palette.fg, s:palette.bg4)
call lilium#highlight('MiniTablineHidden', s:palette.grey, s:palette.bg2)
call lilium#highlight('MiniTablineModifiedCurrent', s:palette.blue, s:palette.bg4)
call lilium#highlight('MiniTablineModifiedHidden', s:palette.grey, s:palette.bg2)
call lilium#highlight('MiniTablineModifiedVisible', s:palette.blue, s:palette.bg2)
call lilium#highlight('MiniTablineTabpagesection', s:palette.bg0, s:palette.blue, 'bold')
call lilium#highlight('MiniTablineVisible', s:palette.fg, s:palette.bg2)
call lilium#highlight('MiniTestEmphasis', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('MiniTestFail', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('MiniTestPass', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('MiniTrailspace', s:palette.none, s:palette.red)
...
call lilium#highlight('LightspeedLabel', s:palette.red, s:palette.none, 'bold,underline')
call lilium#highlight('LightspeedLabelDistant', s:palette.blue, s:palette.none, 'bold,underline')
call lilium#highlight('LightspeedShortcut', s:palette.bg0, s:palette.red, 'bold')
call lilium#highlight('LightspeedUnlabeledMatch', s:palette.fg, s:palette.none, 'bold')
call lilium#highlight('LightspeedPendingOpArea', s:palette.bg0, s:palette.green)
...
" For example, the content between `syn_begin: sh/zsh` and `syn_end` will be placed in `after/syntax/sh/lilium.vim` and `after/syntax/zsh/lilium.vim`.
if lilium#syn_exists(s:path) " If the syntax files exist.
  if s:configuration.better_performance
    if !lilium#syn_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call lilium#syn_clean(s:path, 0)
      call lilium#syn_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call lilium#syn_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call lilium#syn_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" syn_begin: vim-plug {{{
" https://github.com/junegunn/vim-plug
call lilium#highlight('plug1', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('plugNumber', s:palette.yellow, s:palette.none, 'bold')
...
if !s:configuration.transparent_background
  call lilium#highlight('NvimTreeNormal', s:palette.fg, s:palette.bg_dim)
  call lilium#highlight('NvimTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call lilium#highlight('NvimTreeVertSplit', s:palette.bg0, s:palette.bg0)
  call lilium#highlight('NvimTreeCursorLine', s:palette.none, s:palette.bg0)
endif
...
if !s:configuration.transparent_background
  call lilium#highlight('NeoTreeNormal', s:palette.fg, s:palette.bg_dim)
  call lilium#highlight('NeoTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call lilium#highlight('NeoTreeVertSplit', s:palette.bg0, s:palette.bg0)
endif
...
call lilium#highlight('OctoViewer', s:palette.bg0, s:palette.blue)
call lilium#highlight('OctoGreenFloat', s:palette.green, s:palette.bg2)
call lilium#highlight('OctoRedFloat', s:palette.red, s:palette.bg2)
call lilium#highlight('OctoPurpleFloat', s:palette.purple, s:palette.bg2)
call lilium#highlight('OctoYellowFloat', s:palette.yellow, s:palette.bg2)
call lilium#highlight('OctoBlueFloat', s:palette.blue, s:palette.bg2)
call lilium#highlight('OctoGreyFloat', s:palette.grey, s:palette.bg2)
call lilium#highlight('OctoBubbleGreen', s:palette.bg0, s:palette.green)
call lilium#highlight('OctoBubbleRed', s:palette.bg0, s:palette.red)
call lilium#highlight('OctoBubblePurple', s:palette.bg0, s:palette.purple)
call lilium#highlight('OctoBubbleYellow', s:palette.bg0, s:palette.yellow)
call lilium#highlight('OctoBubbleBlue', s:palette.bg0, s:palette.blue)
call lilium#highlight('OctoBubbleGrey', s:palette.bg0, s:palette.grey)
...
call lilium#highlight('UndotreeSavedBig', s:palette.red, s:palette.none, 'bold')
...
" syn_begin: markdown {{{
" builtin: {{{
call lilium#highlight('markdownH1', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('markdownH2', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('markdownH3', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('markdownH4', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('markdownH5', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('markdownH6', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('markdownUrl', s:palette.blue, s:palette.none, 'underline')
call lilium#highlight('markdownItalic', s:palette.none, s:palette.none, 'italic')
call lilium#highlight('markdownBold', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('markdownItalicDelimiter', s:palette.grey, s:palette.none, 'italic')
...
call lilium#highlight('mkdURL', s:palette.blue, s:palette.none, 'underline')
call lilium#highlight('mkdInlineURL', s:palette.blue, s:palette.none, 'underline')
call lilium#highlight('mkdItalic', s:palette.grey, s:palette.none, 'italic')
...
" syn_end }}}
" syn_begin: vimwiki {{{
call lilium#highlight('VimwikiHeader1', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('VimwikiHeader2', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('VimwikiHeader3', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('VimwikiHeader4', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('VimwikiHeader5', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('VimwikiHeader6', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('VimwikiLink', s:palette.blue, s:palette.none, 'underline')
call lilium#highlight('VimwikiItalic', s:palette.none, s:palette.none, 'italic')
call lilium#highlight('VimwikiBold', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('VimwikiUnderline', s:palette.none, s:palette.none, 'underline')
...
call lilium#highlight('rstStandaloneHyperlink', s:palette.purple, s:palette.none, 'underline')
call lilium#highlight('rstEmphasis', s:palette.none, s:palette.none, 'italic')
call lilium#highlight('rstStrongEmphasis', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('rstStandaloneHyperlink', s:palette.blue, s:palette.none, 'underline')
call lilium#highlight('rstHyperlinkTarget', s:palette.blue, s:palette.none, 'underline')
...
call lilium#highlight('htmlH1', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('htmlH2', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('htmlH3', s:palette.yellow, s:palette.none, 'bold')
call lilium#highlight('htmlH4', s:palette.green, s:palette.none, 'bold')
call lilium#highlight('htmlH5', s:palette.blue, s:palette.none, 'bold')
call lilium#highlight('htmlH6', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('htmlLink', s:palette.none, s:palette.none, 'underline')
call lilium#highlight('htmlBold', s:palette.none, s:palette.none, 'bold')
call lilium#highlight('htmlBoldUnderline', s:palette.none, s:palette.none, 'bold,underline')
call lilium#highlight('htmlBoldItalic', s:palette.none, s:palette.none, 'bold,italic')
call lilium#highlight('htmlBoldUnderlineItalic', s:palette.none, s:palette.none, 'bold,underline,italic')
call lilium#highlight('htmlUnderline', s:palette.none, s:palette.none, 'underline')
call lilium#highlight('htmlUnderlineItalic', s:palette.none, s:palette.none, 'underline,italic')
call lilium#highlight('htmlItalic', s:palette.none, s:palette.none, 'italic')
...
call lilium#highlight('semshiUnresolved', s:palette.orange, s:palette.none, 'undercurl')
...
" syn_end }}}
" syn_begin: vim {{{
call lilium#highlight('vimCommentTitle', s:palette.grey, s:palette.none, 'bold')
...
" syn_end }}}
" syn_begin: toml {{{
call lilium#highlight('tomlTable', s:palette.purple, s:palette.none, 'bold')
...
" syn_end }}}
" syn_begin: dosini {{{
call lilium#highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Blue
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" syn_end }}}
" syn_begin: help {{{
call lilium#highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call lilium#highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call lilium#highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call lilium#highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call lilium#highlight('helpHyperTextEntry', s:palette.blue, s:palette.none, 'bold')
